...
```{r}
setwd("/Users/grantkim/FinalProj/data/raw")

suppressWarnings({
  library(readxl)
data <- read_excel("sheet1.xls")
})
...
```{r}
library(readr)
sheet2 <- read_csv("/Users/grantkim/FinalProj/data/raw/sheet2.csv")
...
setwd("data/cleaned_and_ready")

write.csv(merged_data, "data_cleaned.csv", row.names = FALSE)
